...
impl ArtworkListing {
	...
	pub async fn get_listing(
		...
		let ugoira_enabled = env::var("UGOIRA_ENABLED").unwrap_or_else(|_| String::from("false")) == "true";
	...
	pub fn to_template(self, image_index: Option<usize>, host: String) -> anyhow::Result<String> {
		...
		let tag_string = Itertools::intersperse_with(self.tags.into_iter(), || String::from(", ")).collect::<String>();
